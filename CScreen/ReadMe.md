...
The `CScreen` project contains the database schema and scripts to build the database.  
...
```pwsh
sqlpackage /Action:Publish /SourceFile:"bin/Debug/CScreen.dacpac" /TargetConnectionString:"Data Source=TONY23-PC\DEVSQL;Initial Catalog=CScreen;Integrated Security=True;Persist Security Info=False;Pooling=False;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=True;Command Timeout=30;"
```
