CREATE PROCEDURE [dbo].[sp_GetZoneDataStartEndTimes]
   @ConfigID     INT,
...
AS
   ...
   BEGIN
      ...
      FROM Measurement, Zone_Message, Zone
      WHERE Measurement.ID = Zone_Message.MeasurementID AND
...
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_GetZoneDataStartEndTimes] TO [DTSReadRole]
    AS [dbo];
GO
